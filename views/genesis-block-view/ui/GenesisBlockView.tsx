...
type GenesisBlockViewProps = {
  onSuccess: () => void;
};

export function GenesisBlockView({ onSuccess }: GenesisBlockViewProps) {
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-[#1e293b] border border-slate-700/50 rounded-xl p-6 shadow-xl">
          ...
          <p className="text-slate-400 text-sm mb-6">
            Be the first to start the game by creating the initial block. Enter
            a theme hint for the AI to generate the password.
          </p>
